...
function App() {
	return (
		<div className="relative min-h-screen bg-gradient-to-r from-green-300 to-green-200">
			<img src={logo} className="mx-auto my-auto mb-2" id="logo" alt="logo" />
			<Navbar />
			<div className="sm:max-w-2xl flex-col mx-auto rounded-md shadow-xl items-center justify-center border border-green-500 bg-gradient-to-t from-green-200/50 to-green-100/70 p-6">
				<Routes>
